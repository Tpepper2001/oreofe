...
/* ===================== MEMBER MANAGEMENT (KEYBOARD + SHIFT ENGINE) ===================== */
...
const MemberManagement = ({ members, transactions, onRefresh, showToast, colors, isAdmin, mode, confirmAction, setBulkPrintList }) => {
  ...
  const handleKeyboard = (e) => {
    ...
    if (e.key === 'ArrowDown') {
      ...
      e.preventDefault();
      toggleSelection(filtered[focusedIdx].id);
      ...
      {selectedIds.length > 0 && (
        <div style={{...styles.floatingBar, background: colors.card, borderColor: colors.primary}}>
          ...
          <div style={{display:'flex', gap: 8}}>
            ...
            <button onClick={() => setSelectedIds([])} style={{...styles.btnSecondary, padding: '8px 16px', fontSize: 12}}>Unselect</button>
          </div>
        </div>
      )}
          ...
          return (
            <div key={m.id} 
              ...
              style={{ 
                ...
                boxShadow: isFocused ? `0 0 10px ${colors.primary}33` : 'none'
              }}>
